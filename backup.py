...
def update_static_elements(kpi_data):
    ...
    pixoo_screen = 64  # Assuming this is defined elsewhere
    ...
    try:
        ...
        try:
            font = ImageFont.truetype("views/fonts/TinyUnicode.ttf", 8)
        except IOError:
    ...
    # Draw static text
    draw.text((14, 6), f"{kpi_data['green_flags']}", fill=(text_r, text_g, text_b), font=font)
    draw.text((14, 22), f"{kpi_data['red_flags']}", fill=(text_r, text_g, text_b), font=font)
    draw.text((14, 37), f"{kpi_data['attendance']}%", fill=(text_r, text_g, text_b), font=font)
    ...
    if kpi_data.get("showDateTime"):
        ...
        draw.text((2, 49), country_code, fill=(text_r, text_g, text_b), font=font)
        draw.text((2, 57), f"{now_date} {now_time}", fill=(text_r, text_g, text_b), font=font)
